...
($context["item"] ?? null), "update_status", [], "any", false, false, false, 65) == 4)) {
    ...
    {
        return new Source("", "@admin/Store/plugin_detail_modal.twig", "/Applications/MAMP/htdocs/eccube-4.0.5/src/Eccube/Resource/template/admin/Store/plugin_detail_modal.twig");
    }
}
