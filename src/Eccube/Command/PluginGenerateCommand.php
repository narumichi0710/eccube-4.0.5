...
EOL;
        $this->fs->dumpFile($pluginDir.'/StockShowEvent.php', $source);
    }
...
use Plugin\\${code}\\Form\\Type\\Admin\\StockShowConfigType;
use Plugin\\${code}\\Repository\\StockShowConfigRepository;
...
class ConfigController extends AbstractController
{
    ...
    {
        \$StockShowConfig = \$this->configRepository->get();
        \$form = \$this->createForm(StockShowConfigType::class, \$StockShowConfig);
        \$form->handleRequest(\$request);

        if (\$form->isSubmitted() && \$form->isValid()) {
            \$StockShowConfig = \$form->getData();
            \$this->entityManager->persist(\$StockShowConfig);
            \$this->entityManager->flush(\$StockShowConfig);
 ...
 * @ORM\Entity(repositoryClass="Plugin\\${code}\\Repository\\StockShowConfigRepository")
 */
...
EOL;
        ...
        $this->fs->dumpFile($pluginDir.'/Entity/StockShowConfig.php', $source);
...
use Plugin\\${code}\\Entity\\StockShowConfig;
...
EOL;
        ...
        $this->fs->dumpFile($pluginDir.'/Repository/StockShowConfigRepository.php', $source);
...
EOL;
        ...
        $this->fs->dumpFile($pluginDir.'/Form/Type/Admin/StockShowConfigType.php', $source);
